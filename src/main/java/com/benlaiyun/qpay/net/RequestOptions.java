...
public class RequestOptions {
    ...
    public static RequestOptions getDefault(String uri, String version) {
        return new RequestOptions(
                uri,
                version,
                QPay.DEFAULT_SIGN_TYPE,
                QPay.appId,
                QPay.apiKey,
                QPay.getConnectTimeout(),
                QPay.getReadTimeout(),
                QPay.getMaxNetworkRetries(),
                QPay.getAcceptLanguage());
    }
    ...
    public static class RequestOptionsBuilder {
        ...
        public RequestOptionsBuilder() {
            this.signType = QPay.DEFAULT_SIGN_TYPE;
            this.appId = QPay.appId;
            this.apiKey = QPay.apiKey;
            this.connectTimeout = QPay.getConnectTimeout();
            this.readTimeout = QPay.getReadTimeout();
            this.maxNetworkRetries = QPay.getMaxNetworkRetries();
            this.acceptLanguage = QPay.getAcceptLanguage();
        }
