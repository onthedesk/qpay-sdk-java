...
import com.benlaiyun.qpay.util.StreamUtils;
...
public class HttpURLConnectionClient extends HttpClient {
    ...
    static HttpHeaders getHeaders(APIJeepayRequest request) {
        ...
        userAgentHeadersMap.put(
                "X-Jeepay-Client-User-Agent", Collections.singletonList(buildXJeepayClientUserAgentString(request.getOptions().getVersion())));
