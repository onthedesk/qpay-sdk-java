...
import com.benlaiyun.qpay.ApiField;
import com.benlaiyun.qpay.ApiListField;
...
public class JSONWriter {
    ...
    private void date(Date date) {
        if (this.format == null) {
            this.format = new SimpleDateFormat(QPay.DATE_TIME_FORMAT);
            this.format.setTimeZone(TimeZone.getTimeZone(QPay.DATE_TIMEZONE));
        }
        add("\"");
